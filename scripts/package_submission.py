...
def main() -> None:
    ...
    mappings = {
        ...
        "docs/reference/DATA_SOURCES.md": "DATA_SOURCES.md",
        "docs/reference/MODEL_AND_COST_CARD.md": "MODEL_AND_COST_CARD.md",
        "docs/reference/SAFETY_AND_LIMITATIONS.md": "SAFETY_AND_LIMITATIONS.md",
        "docs/reference/THIRD_PARTY_NOTICES.md": "THIRD_PARTY_NOTICES.md",
        "README.md": "README.md",
        "uv.lock": "dependency-locks/uv.lock",
        "package-lock.json": "dependency-locks/package-lock.json",
        "docs/guides/DEMO_RUNBOOK.md": "demo-runbook.md",
